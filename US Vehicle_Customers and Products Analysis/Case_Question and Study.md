...
```
By calcuation, the customer lifetime value is $39039, which means the average profit generated by a customer during the lifetime. Let say investing 10% of the the average profit/customer to attract potential buyer, the company can spend $3904 for each person.
